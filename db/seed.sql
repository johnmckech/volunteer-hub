...
VALUES
  ('Sean', 'Suwanaloet', 'suwanaloet@wisc.edu', 'English', 'Microsoft Word', 'Grant Writing', '5'),
  ('Jane', 'Doe', 'janedoe@fakeemail.com', 'French', 'Facebook', 'Web Development', '10');
  

insert into opportunities (opportunityName, languages, techKnowledge, specialKnowledge, hoursPerWeek)
VALUES
